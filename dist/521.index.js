...
var client = __webpack_require__(9728);
...
var client = __webpack_require__(9728);
var tokenProviders = __webpack_require__(4682);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(9132); });
    const sso = ssoClient ||
...
var sso = __webpack_require__(9982);
...
const core_1 = __webpack_require__(6992);
...
const ruleset_1 = __webpack_require__(7028);
...
var middlewareUserAgent = __webpack_require__(4608);
...
var httpAuthSchemeProvider = __webpack_require__(1297);
var runtimeConfig = __webpack_require__(4960);
var regionConfigResolver = __webpack_require__(2585);
var protocolHttp = __webpack_require__(9228);
var schemas_0 = __webpack_require__(7614);
var errors = __webpack_require__(9330);
var SSOServiceException = __webpack_require__(3098);
...
const SSOServiceException_1 = __webpack_require__(3098);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(2743));
const core_1 = __webpack_require__(6992);
const util_user_agent_node_1 = __webpack_require__(1694);
...
const runtimeConfig_shared_1 = __webpack_require__(7985);
...
exports.getRuntimeConfig = void 0;
const core_1 = __webpack_require__(6992);
const protocols_1 = __webpack_require__(4552);
...
const httpAuthSchemeProvider_1 = __webpack_require__(1297);
const endpointResolver_1 = __webpack_require__(8983);
const schemas_0_1 = __webpack_require__(7614);
const getRuntimeConfig = (config) => {
    return {
...
const errors_1 = __webpack_require__(9330);
const SSOServiceException_1 = __webpack_require__(3098);
...
var client = __webpack_require__(9728);
var httpAuthSchemes = __webpack_require__(8803);
var propertyProvider = __webpack_require__(4036);
var sharedIniFileLoader = __webpack_require__(7016);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 320).then(__webpack_require__.t.bind(__webpack_require__, 320, 23));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 320).then(__webpack_require__.t.bind(__webpack_require__, 320, 23));
