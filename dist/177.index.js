...
var core = __webpack_require__(692);
...
var middlewareRetry = __webpack_require__(608);
var smithyClient = __webpack_require__(6104);
var httpAuthSchemeProvider = __webpack_require__(1882);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(1272));
const core_1 = __webpack_require__(4305);
...
const runtimeConfig_shared_1 = __webpack_require__(9592);
...
const httpAuthSchemeProvider_1 = __webpack_require__(1882);
const endpointResolver_1 = __webpack_require__(9268);
const getRuntimeConfig = (config) => {
    return {
...
var client = __webpack_require__(7705);
var tokenProviders = __webpack_require__(2269);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(6424); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(945);
...
var client = __webpack_require__(7705);
var httpAuthSchemes = __webpack_require__(2876);
var propertyProvider = __webpack_require__(4200);
var sharedIniFileLoader = __webpack_require__(5285);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 771).then(__webpack_require__.t.bind(__webpack_require__, 9771, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 771).then(__webpack_require__.t.bind(__webpack_require__, 9771, 19));
