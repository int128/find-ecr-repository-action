...
var credentialProviderLogin = __webpack_require__(5161);

const resolveCredentialSource = (credentialSource, profileName, logger) => {
    const sourceProvidersMap = {
        EcsContainer: async (options) => {
            const { fromHttp } = await __webpack_require__.e(/* import() */ 875).then(__webpack_require__.bind(__webpack_require__, 875));
        ...
        Environment: async (options) => {
            ...
            const { fromEnv } = await Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 5005, 19));
...
const resolveAssumeRoleCredentials = async (profileName, profiles, options, callerClientConfig, visitedProfiles = {}, resolveProfileData) => {
    ...
    if (!options.roleAssumer) {
        const { getDefaultRoleAssumer } = await __webpack_require__.e(/* import() */ 288).then(__webpack_require__.t.bind(__webpack_require__, 9288, 23));
...
const resolveProcessCredentials = async (options, profile) => __webpack_require__.e(/* import() */ 17).then(__webpack_require__.t.bind(__webpack_require__, 1017, 19)).then(({ fromProcess }) => fromProcess({
    ...options,
    profile,
...
const resolveSsoCredentials = async (profile, profileData, options = {}, callerClientConfig) => {
    const { fromSSO } = await __webpack_require__.e(/* import() */ 177).then(__webpack_require__.t.bind(__webpack_require__, 7177, 19));
    return fromSSO({
        profile,
...
const isWebIdentityProfile = (arg) => Boolean(arg) &&
    ...
    typeof arg.role_arn === "string" &&
    ["undefined", "string"].indexOf(typeof arg.role_session_name) > -1;
const resolveWebIdentityCredentials = async (profile, options, callerClientConfig) => __webpack_require__.e(/* import() */ 469).then(__webpack_require__.t.bind(__webpack_require__, 5469, 23)).then(({ fromTokenFile }) => fromTokenFile({
