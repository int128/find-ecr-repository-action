...
const client_1 = __webpack_require__(9728);
...
const fromWebToken_1 = __webpack_require__(5626);
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
    ...
    if (!roleAssumerWithWebIdentity) {
        const { getDefaultRoleAssumerWithWebIdentity } = await Promise.resolve().then(() => __importStar(__webpack_require__(2013)));
...
var fromTokenFile = __webpack_require__(9954);
var fromWebToken = __webpack_require__(5626);
